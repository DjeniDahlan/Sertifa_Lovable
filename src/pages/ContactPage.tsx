    ...
    <>
      ...
      <div className="bg-gradient-to-r from-sertifa-purple to-sertifa-darkpurple text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-lg">Hubungi kami untuk informasi lebih lanjut mengenai sertifikasi dan layanan LSP Sertifa</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div>
            ...
            <div className="space-y-6">
              <Card className="border-none shadow-sm">
                <CardContent className="flex items-start p-5">
                  <MapPin className="w-5 h-5 text-sertifa-purple mr-4 mt-0.5" />
                  <div>
                    <h3 className="font-semibold mb-2">Alamat</h3>
                    <p className="text-gray-600">
                      Gedung IT Center, Lantai 5<br />
              ...
              <Card className="border-none shadow-sm">
                <CardContent className="flex items-start p-5">
                  <Phone className="w-5 h-5 text-sertifa-purple mr-4 mt-0.5" />
                  <div>
              ...
              <Card className="border-none shadow-sm">
                <CardContent className="flex items-start p-5">
                  <Mail className="w-5 h-5 text-sertifa-purple mr-4 mt-0.5" />
                  <div>
                    <h3 className="font-semibold mb-2">Email</h3>
                    <p className="text-gray-600">
                      info@lspsertifa.co.id<br />
                      administrasi@lspsertifa.co.id
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-none shadow-sm">
                <CardContent className="flex items-start p-5">
                  <Clock className="w-5 h-5 text-sertifa-purple mr-4 mt-0.5" />
                  <div>
            ...
            <div className="mt-8">
              <h2 className="text-2xl font-bold mb-6 text-sertifa-purple">Sosial Media</h2>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-sertifa-purple rounded-full flex items-center justify-center text-white hover:bg-sertifa-darkpurple transition-colors">
              ...
              <CardContent className="pt-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea id="message" placeholder="Masukkan pesan Anda" rows={5} required />
                  </div>
        ...
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-6 text-sertifa-purple">Lokasi Kami</h2>
