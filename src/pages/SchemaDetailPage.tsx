              ...
              <div className="md:w-1/3">
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 shadow-lg">
                  <div className="flex justify-between items-center mb-4">
                    <span className="text-lg font-bold">Biaya Sertifikasi</span>
                  ...
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>Tertulis, Praktik, Wawancara</span>
                    </div>
                  </div>
                  <Button
                    asChild
        ...
        <div className="max-w-4xl mx-auto">
          <section className="mb-12">
            <div className="flex flex-col md:flex-row gap-8">
              <div className="md:w-1/2">
                <img 
                  src={`https://source.unsplash.com/random/800x600/?${scheme.title.toLowerCase().replace(/\s+/g, ',')},certification,professional`} 
                  alt={scheme.title}
          ...
          <section className="mb-12">
            <div className="flex flex-col md:flex-row gap-8 items-center mb-6">
              <div className="md:w-1/2">
                <h2 className="text-2xl font-bold mb-4 text-sertifa-purple">Unit Kompetensi</h2>
                <p className="text-gray-600 mb-4">
                  Skema sertifikasi ini terdiri dari beberapa unit kompetensi yang harus dikuasai oleh peserta
                  untuk mendapatkan sertifikat kompetensi.
                </p>
              </div>
              <div className="md:w-1/2">
                <img 
                  src="https://images.unsplash.com/photo-1512758017271-d7b84c2113f1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" 
                  alt="Unit Kompetensi"
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold mb-8 text-sertifa-purple text-center">Proses Sertifikasi</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold mb-6 text-sertifa-purple">Keunggulan Sertifikasi</h2>
          ...
          <div className="bg-gradient-to-r from-sertifa-purple to-sertifa-darkpurple text-white p-8 rounded-lg shadow-md">
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-6 md:mb-0 md:mr-8">
                <h3 className="text-2xl font-bold mb-2">Mulai Perjalanan Sertifikasi Anda</h3>
                <p className="text-lg">
          ...
          <div className="mt-10">
            <h2 className="text-2xl font-bold mb-6 text-sertifa-purple">Skema Sertifikasi Lainnya</h2>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start">
                        <div className="w-20 h-20 bg-gray-100 rounded-lg overflow-hidden mr-4 flex-shrink-0">
                          <img 
                            src={`https://source.unsplash.com/random/200x200/?${otherScheme.title.toLowerCase().replace(/\s+/g, ',')},certification`} 
                        ...
                        <div>
                          <div className="mb-1">
                            <span className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${
                              ...
                              {otherScheme.type === "okupasi" ? "Okupasi" : "Klaster"}
                            </span>
                          </div>
